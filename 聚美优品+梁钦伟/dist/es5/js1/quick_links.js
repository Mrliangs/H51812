...
jQuery(function ($) {
	...
	var quickPopXHR,
		...
		//		message_list: {
		//			title: '购物车',
		//			content: '<div class="ibar_plugin_content"><div class="ibar_cart_group ibar_cart_product"><div class="ibar_cart_group_header"><span class="ibar_cart_group_title">模板堂</span><a href="#" class="guowu">我的购物车</a></div><ul><li class="cart_item"><div class="cart_item_pic"><a href="#" class="cart-img"></a></div><div class="cart_item_desc"><a href="#" class="cart_item_name">夏季透气真皮豆豆鞋反绒男士休闲鞋韩版磨砂驾车鞋英伦船鞋男鞋子</a><div class="cart_item_sku"><span>尺码：38码（精工限量版）</span></div><div class="cart_item_price"><span class="cart_price">￥700.00</span></div></div>	</li></ul></div><div class="cart_handler"><div class="cart_handler_header"><span class="cart_handler_left">共<span class="cart_price">1</span>件商品</span><span class="cart_handler_right">￥569.00</span></div><a href="shopping.html" class="cart_go_btn" target="_blank">去购物车结算</a></div></div>',
		//			init:$.noop
		//		},
		...
		mpbtn_histroy: {
			title: '我的足迹',
			content: '<div class="ibar_plugin_content"><div class="ibar-history-head">共3件产品<a href="#">清空</a></div><div class="ibar-moudle-product"><div class="imp_item"><a href="#" class="pic"><img src="img/index-img/xiez.jpg" width="100" height="100" /></a><p class="tit"><a href="#">夏季透气真皮豆豆鞋反绒男士休闲鞋韩</a></p><p class="price"><em>￥</em>649.00</p><a href="#" class="imp-addCart">加入购物车</a></div><div class="imp_item"><a href="#" class="pic"><img src="img/index-img/xiez.jpg" width="100" height="100" /></a><p class="tit"><a href="#">夏季透气真皮豆豆鞋反绒男士休闲鞋韩</a></p><p class="price"><em>￥</em>649.00</p><a href="#" class="imp-addCart">加入购物车</a></div><div class="imp_item"><a href="#" class="pic"><img src="img/index-img/xiez.jpg" width="100" height="100" /></a><p class="tit"><a href="#">夏季透气真皮豆豆鞋反绒男士休闲鞋韩</a></p><p class="price"><em>￥</em>649.00</p><a href="#" class="imp-addCart">加入购物车</a></div></div></div>',
			init: $.noop
		},
		mpbtn_wdsc: {
			title: '收藏的产品',
			content: '<div class="ibar_plugin_content"><div class="ibar_cart_group ibar_cart_product"><ul><li class="cart_item"><div class="cart_item_pic"><a href="#"><img src="img/index-img/xiez.jpg" /></a></div><div class="cart_item_desc"><a href="#" class="cart_item_name">夏季透气真皮豆豆鞋反绒男士休闲鞋韩版磨砂驾车鞋英伦船鞋男鞋子</a><div class="cart_item_sku"><span>尺码：38码（精工限量版）</span></div><div class="cart_item_price"><span class="cart_price">￥700.00</span><a href="#" class="sc" title="删除"><img src="img/index-img/sc.png" alt="删除" /></a></div></div>	</li></ul></div><div class="cart_handler"><a href="#" class="cart_go_btn jiaru" target="_blank">加入购物车</a></div></div>',
			init: $.noop
		},
		mpbtn_recharge: {
			title: '手机充值',
	...
	var prevPopType,
	    ...
	    doc = $(document),
	    popDisplayed = false,
	    hideQuickPop = function hideQuickPop() {
		if (prevTrigger) {
		...
		prevPopType = '';
		quickPop.hide();
		quickPop.animate({ left: -280, queue: false });
	},
	    showQuickPop = function showQuickPop(type) {
	...
	var view = $(window),
	    ...
	    getHandlerType = function getHandlerType(className) {
		...
		//返回顶部
		return_top: function return_top() {
			ds.scrollTo(0, 0);
			hideReturnTop();
		}
	};
