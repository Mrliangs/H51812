 ...
 */
	...
	var fDomExtend = function fDomExtend(collection) {
		...
		document.createEvent = function (type) {
			...
			switch (type) {
				case "Event":case "Events":case "HTMLEvents":
					{
						event = {
							initEvent: function initEvent(eventType, canBubble, cancelable) {
				...
				case "MouseEvents":
					{
						event = {
							initMouseEvent: function initMouseEvent(eventType, canBubble, cancelable, view, detail, screenX, screenY, clientX, clientY, ctrlKey, altKey, shiftKey, metaKey, button, relatedTarget) {
								event.type = eventType;
								event.canBubble = canBubble || false;
								event.cancelable = cancelable || false;
				...
				case "UIEvents":
					{
						event = {
							initUIEvent: function initUIEvent(eventType, canBubble, cancelable, view, detail) {
								event.type = eventType;
								event.canBubble = canBubble || false;
								event.cancelable = cancelable || false;
								event.view = view || null;
